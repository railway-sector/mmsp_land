import{vg as X,Fi as Z,Fj as ee,DX as te,DV as ie,Fk as re,Fl as ae,E0 as o,Fb as se,Ez as oe,Fa as ne,D$ as w,Fm as ce,Fn as le,DY as pe,D_ as de,E1 as he,EW as ve,E3 as ue,Fo as A,Fp as N,Fq as me,Fr as fe,ED as ge,hK as Se,E4 as Pe,E5 as ye,_ as _e,E6 as E,E8 as R,E9 as we,Ea as U,Eb as C,EE as ze,Ed as xe,Ee as $e,Eg as be,Ec as Te,Eh as V,Fs as Ve,Ft as I,Fu as B,Fv as De,Fw as ke,Fx as Oe,Ei as Fe,n as p,Ej as d,hH as We,EG as Ee,Fy as q,qU as Ce,F2 as Me,kP as Le,Eo as je,dQ as H,cM as G,w_ as Ae,gg as Y,Fz as Ne}from"./index-JSX_D-TK.js";function Q(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
