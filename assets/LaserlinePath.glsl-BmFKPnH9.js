import{cT as o,dS as pe,dN as T,kr as ue,hA as Q,sL as fe,kp as ge,jq as _e,g9 as Y,G5 as me,G2 as ve,Gy as Pe,Ec as f,Fm as w,G7 as be,Ed as z,Ea as r,eS as U,vd as Z,G4 as we,F4 as S,sF as Ve,ga as m,ia as $,gF as N,Gz as De,mF as K,Fk as ee,EL as C,sJ as Ee,gb as v,GA as te,kQ as ie,fn as ne,iK as xe,iI as ye,hL as Le,iZ as Se,i9 as Ce,dO as se,sG as Me,Ee as ae,Ef as re,_ as le,Gb as Ae,E2 as $e,cW as F,iR as I,G3 as Re,vt as Te,c_ as Oe,EJ as Ie,Fu as Ue,E9 as G,GB as qe,n as u,Et as D,Gc as je,Gd as W,GC as ze,lj as Ne,GD as R,GE as Fe,iT as Ge,iV as We,uc as He,iW as Be,iX as ke,iY as Xe,p as M,u as Je,GF as Qe,cY as H}from"./index-XsDH7010.js";import{t as Ye}from"./VisualElement-W0hjCWQM.js";let B=class{constructor(e){this._renderCoordsHelper=e,this._origin=o(),this._dirty=!1,this._count=0}set vertices(e){const n=pe(3*e.length);let i=0;for(const s of e)n[i++]=s[0],n[i++]=s[1],n[i++]=s[2];this.buffers=[n]}set buffers(e){if(this._buffers=e,this._buffers.length>0){const n=this._buffers[0],i=3*Math.floor(n.length/3/2);T(this._origin,n[i],n[i+1],n[i+2])}else T(this._origin,0,0,0);this._dirty=!0}get origin(){return this._origin}draw(e){const n=this._ensureVAO(e);n!=null&&(e.bindVAO(n),e.drawArrays(ue.TRIANGLES,0,this._count))}dispose(){this._vao!=null&&this._vao.dispose()}get _layout(){return this._renderCoordsHelper.viewingMode===1?Ke:et}_ensureVAO(e){return this._buffers==null?null:(this._vao??=this._createVAO(e,this._buffers),this._ensureVertexData(this._vao,this._buffers),this._vao)}_createVAO(e,n){const i=this._createDataBuffer(n);return this._dirty=!1,new fe(e,new ge(e,_e(this._layout),i))}_ensureVertexData(e,n){if(!this._dirty)return;const i=this._createDataBuffer(n);e.buffer()?.setData(i),this._dirty=!1}_createDataBuffer(e){const n=e.reduce((g,c)=>g+k(c),0);this._count=n;const i=this._layout.createBuffer(n),s=this._origin;let a=0,l=0;const d="startUp"in i?this._setUpVectors.bind(this,i):void 0;for(const g of e){for(let c=0;c<g.length;c+=3){const L=T(X,g[c],g[c+1],g[c+2]);c===0?l=this._renderCoordsHelper.getAltitude(L):this._renderCoordsHelper.setAltitude(L,l);const _=a+2*c;d?.(c,_,g,L);const j=Y(X,L,s);if(c<g.length-3){for(let P=0;P<6;P++)i.start.setVec(_+P,j);i.extrude.setValues(_,0,-1),i.extrude.setValues(_+1,1,-1),i.extrude.setValues(_+2,1,1),i.extrude.setValues(_+3,0,-1),i.extrude.setValues(_+4,1,1),i.extrude.setValues(_+5,0,1)}if(c>0)for(let P=-6;P<0;P++)i.end.setVec(_+P,j)}a+=k(g)}return i.buffer}_setUpVectors(e,n,i,s,a){const l=this._renderCoordsHelper.worldUpAtPosition(a,Ze);if(n<s.length-3)for(let d=0;d<6;d++)e.startUp.setVec(i+d,l);if(n>0)for(let d=-6;d<0;d++)e.endUp.setVec(i+d,l)}};function k(t){return 3*(2*(t.length/3-1))}const Ze=o(),X=o(),Ke=Q().vec3f("start").vec3f("end").vec2f("extrude").vec3f("startUp").vec3f("endUp"),et=Q().vec3f("start").vec3f("end").vec2f("extrude");function oe(t,e){const n=t.fragment;n.include(me),t.include(ve),n.include(Pe),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new be("depthMap",i=>i.depth?.attachment),new z("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new C("angleCutoff",s=>A(s)),new S("heightPlane",(s,a)=>he(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,p),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new C("angleCutoff",i=>A(i)),new S("pointDistanceSphere",(i,s)=>Ee(tt(i,s)))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
...
}`)),t.intersectsLineEnabled&&(n.uniforms.add(new C("angleCutoff",i=>A(i)),new w("intersectsLineStart",(i,s)=>m(p,i.lineStartWorld,s.camera.viewMatrix)),new w("intersectsLineEnd",(i,s)=>m(p,i.lineEndWorld,s.camera.viewMatrix)),new w("intersectsLineDirection",(i,s)=>(v(h,i.intersectsLineSegment.vector),h[3]=0,$(p,te(h,h,s.camera.viewMatrix)))),new f("intersectsLineRadius",i=>i.intersectsLineRadius)),n.main.add(r`if (pointIsWithinLine(pos, intersectsLineStart, intersectsLineEnd)) {
float intersectsLineDistance = lineDistancePixels(intersectsLineStart, intersectsLineDirection, intersectsLineRadius, pos);
vec4 intersectsLineColor = laserlineProfile(intersectsLineDistance);
float intersectsLineAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, 1.0 - abs(dot(normal, intersectsLineDirection)));
color = max(color, intersectsLineColor * intersectsLineAlpha);
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function A(t){return ie(at,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-U(2))))}function tt(t,e){const n=m(ot,t.pointDistanceOrigin,e.camera.viewMatrix),i=K(t.pointDistanceOrigin,t.pointDistanceTarget);return Le(ct,n,i)}function it(t,e){const n=Se(t.lineVerticalPlaneSegment,.5,p),i=t.renderCoordsHelper.worldUpAtPosition(n,rt),s=$(V,t.lineVerticalPlaneSegment.vector),a=Ce(p,i,s);return $(a,a),he(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function nt(t,e){const n=v(p,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function st(t,e){const n=se(p,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function he(t,e,n){return m(J,t,n),v(h,e),h[3]=0,te(h,h,n),xe(J,h,lt)}const at=ne(),p=o(),h=Ve(),rt=o(),V=o(),J=o(),lt=ye(),ot=o(),ct=Me(),ht=Object.freeze(Object.defineProperty({__proto__:null,build:ce,defaultAngleCutoff:q},Symbol.toStringTag,{value:"Module"}));class dt extends $e{constructor(){super(...arguments),this.innerColor=F(1,1,1),this.innerWidth=1,this.glowColor=F(1,.5,0),this.glowWidth=8,this.glowFalloff=8,this.globalAlpha=.75,this.globalAlphaContrastBoost=2,this.angleCutoff=U(6),this.pointDistanceOrigin=o(),this.pointDistanceTarget=o(),this.lineVerticalPlaneSegment=I(),this.intersectsLineSegment=I(),this.intersectsLineRadius=3,this.heightManifoldTarget=o(),this.lineStartWorld=o(),this.lineEndWorld=o()}}class pt extends ae{constructor(e,n){super(e,n,new re(ht,()=>le(()=>Promise.resolve().then(()=>Pt),void 0)),Ae)}}function de(t){const e=new Z;e.include(oe,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Re("modelView",(a,{camera:l})=>Te(ft,l.viewMatrix,a.origin)),new Ie("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new Ue("pixelToNDC",({camera:a})=>ie(ut,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
    ...
    ${G(s,r`vec3 startUp = vec3(0, 0, 1);`)}
    ${G(s,r`vec3 endUp = vec3(0, 0, 1);`)}
