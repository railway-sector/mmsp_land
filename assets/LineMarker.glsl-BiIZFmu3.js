import{vd as X,Fs as Z,Ft as ee,E5 as te,E3 as ie,Fu as re,Fv as ae,Ea as o,Fl as se,EJ as oe,Fk as ne,E9 as w,Fw as ce,Fx as le,E6 as pe,E8 as de,Eb as he,F4 as ve,Ed as ue,Fy as A,Fz as N,FA as me,FB as fe,EN as ge,hA as Se,Ee as Pe,Ef as ye,_ as _e,Eg as C,Ei as R,Ej as we,Ek as U,El as W,EO as ze,En as xe,Eo as $e,Eq as Te,Em as be,Er as k,FC as ke,FD as I,FE as B,FF as Ve,FG as Oe,FH as De,Es as Ee,n as p,Et as d,hx as Fe,EQ as Ce,FI as q,q_ as We,Fc as Me,kI as Le,Ey as je,dN as H,cT as G,w_ as Ae,ga as J,FJ as Ne}from"./index-XsDH7010.js";function Q(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
