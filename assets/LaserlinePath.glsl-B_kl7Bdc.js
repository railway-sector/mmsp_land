...
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function A(t){return ie(at,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-j(2))))}function tt(t,e){const n=m(ot,t.pointDistanceOrigin,e.camera.viewMatrix),i=Y(t.pointDistanceOrigin,t.pointDistanceTarget);return Le(ct,n,i)}function it(t,e){const n=Se(t.lineVerticalPlaneSegment,.5,p),i=t.renderCoordsHelper.worldUpAtPosition(n,rt),s=$(V,t.lineVerticalPlaneSegment.vector),a=Ce(p,i,s);return $(a,a),he(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function nt(t,e){const n=v(p,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function st(t,e){const n=se(p,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function he(t,e,n){return m(Q,t,n),v(h,e),h[3]=0,te(h,h,n),Ee(Q,h,lt)}const at=ne(),p=o(),h=Ve(),rt=o(),V=o(),Q=o(),lt=ye(),ot=o(),ct=Me(),ht=Object.freeze(Object.defineProperty({__proto__:null,build:ce,defaultAngleCutoff:I},Symbol.toStringTag,{value:"Module"}));class dt extends $e{constructor(){super(...arguments),this.innerColor=F(1,1,1),this.innerWidth=1,this.glowColor=F(1,.5,0),this.glowWidth=8,this.glowFalloff=8,this.globalAlpha=.75,this.globalAlphaContrastBoost=2,this.angleCutoff=j(6),this.pointDistanceOrigin=o(),this.pointDistanceTarget=o(),this.lineVerticalPlaneSegment=U(),this.intersectsLineSegment=U(),this.intersectsLineRadius=3,this.heightManifoldTarget=o(),this.lineStartWorld=o(),this.lineEndWorld=o()}}class pt extends ae{constructor(e,n){super(e,n,new re(ht,()=>le(()=>Promise.resolve().then(()=>Pt),void 0)),Ae)}}function de(t){const e=new J;e.include(oe,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Re("modelView",(a,{camera:l})=>Te(ft,l.viewMatrix,a.origin)),new Ue("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new je("pixelToNDC",({camera:a})=>ie(ut,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
