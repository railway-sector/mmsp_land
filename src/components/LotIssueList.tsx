...
import { lotLayer, querycIssue } from "../layers";
...
const LotIssueList = () => {
  ...
  useEffect(() => {
    ...
    querycIssue.qValues = [contractp, landtype, landsection];
    querycIssue.qExpression = `${lotIssueListField} IS NOT NULL`;

    query.where = querycIssue.queryExpression();
