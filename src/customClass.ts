  ...
  dropDownQuery = async () => {
    ...
    if (this.featureLayers.length === 1) {
      ...
      if (
        ...
        const query11 = this.featureLayers[0].createQuery();
        query11.outFields = ["*"];
        // query11.outFields = [this.fieldNames[0]];
        ...
        const pairQ: any = this.featureLayers[0]
          ...
          .then((response: any) => {
            ...
            const values = stats.map((result: any) => {
        ...
        const query12 = this.featureLayers[0].createQuery();
        query12.outFields = ["*"];
        ...
        const query13 = this.featureLayers[0].createQuery();
        query13.outFields = ["*"];
      ...
      if (
        ...
        const query21p = this.featureLayers[0].createQuery();
        query21p.outFields = ["*"];
        ...
        const query21l = this.featureLayers[1].createQuery();
        query21l.outFields = ["*"];
        ...
        const query22p = this.featureLayers[0].createQuery();
        query22p.outFields = ["*"];
        ...
        // 2. Pairs for 2nd feature layer
        const query22l = this.featureLayers[1].createQuery();
        query22l.outFields = ["*"];
        ...
        // 1. Pairs for 1st feature layer
        const query23p = this.featureLayers[0].createQuery();
        query23p.outFields = ["*"];
        ...
        // 2. Pairs for 2nd feature layer
        const query23l = this.featureLayers[1].createQuery();
        query23l.outFields = ["*"];
